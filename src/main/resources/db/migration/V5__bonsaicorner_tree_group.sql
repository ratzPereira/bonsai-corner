...
--
-- Table structure for table `tree_group`
--
...
CREATE TABLE `tree_group` (
  `id` bigint NOT NULL,
  `tree_group_name` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tree_group`
--

LOCK TABLES `tree_group` WRITE;
/*!40000 ALTER TABLE `tree_group` DISABLE KEYS */;
INSERT INTO `tree_group` VALUES (5,'Conifer'),(6,'Deciduous');
