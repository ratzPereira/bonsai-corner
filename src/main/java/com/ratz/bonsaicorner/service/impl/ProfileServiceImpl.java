...
public class ProfileServiceImpl implements ProfileService {
    ...
    public void deleteProfile() {
        ...
        if (profile == null) throw new ResourceNotFoundException("Profile not found, please create one.");

        if (profile.getProfilePhoto() != null) {
            fileService.deleteImage(user.getProfile().getProfilePhoto());
        }

        profileRepository.customDelete(user);
    }
